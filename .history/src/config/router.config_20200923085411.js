...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      // 云桌面架构
      {
        ...
        name: '用户',
        component: RouteView,
        meta: { title: '云桌面架构', keepAlive: true, icon: icon.cloud, permission: ['framwork'] },
        children: [
            {
              path: '/Cloud/server',
              name: 'server',
              component: () => import('@/views/Cloud/server'),
              meta: { title: '服务器管理', keepAlive: true, icon: icon.server, permission: ['machine'] }
            },
            {
      ...
      // 系统
      {
        ...
        name: 'system',
        component: RouteView,
        meta: { title: '系统', keepAlive: true, icon: icon.system, permission: ['system'] },
        children: [
          {
            path: '/system/organization',
            name: 'organization',
