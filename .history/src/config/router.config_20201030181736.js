...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      // 云桌面架构
      {
        ...
        name: '云桌面架构',
        meta: { title: '云桌面架构', icon: icon.cloud, target: '_blank', permission: ['framwork'] }
      },
      // 系统
      {
        ...
        children: [
          ...
          },
          {
            path: '/system/session',
            name: 'session',
            component: () => import('@/views/system/session'),
            meta: { title: 'session', keepAlive: true, icon: icon.Authorization, permission: ['dashboard'] }
          }
        ]
      }
    ]
