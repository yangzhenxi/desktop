                  ...
                  if (data.role && data.role.resources.length > 0) { // 判断该用户是否有role
                    ...
                    role.resources = data.role.resources
                      ...
                      if (role.resources[0].name === 'all') {
                           Allarr = ['dashboard', 'desktop', 'userManagement', 'usergroup', 'DesktopManagem', 'cloudDesktopmanage', 'framwork', 'machine', 'operating', 'config', 'network', 'system', 'role', 'user', 'info', 'Log']
                      } else {
        ...
        GetInfo ({ commit }) {
            return new Promise((resolve, reject) => {
              getInfo().then(response => {
                ...
                const Allarr = ['dashboard', 'desktop', 'userManagement', 'usergroup', 'DesktopManagem', 'cloudDesktopmanage', 'framwork', 'machine', 'operating', 'config', 'network', 'system', 'role', 'user', 'info', 'Log']
