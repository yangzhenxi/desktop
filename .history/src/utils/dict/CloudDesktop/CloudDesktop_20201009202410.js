export default {
    ...
    C_D_SESSION_LIST_STATE: [
        { key: 'Connected', val: 'Unregistered', color: '#52c41a' },
        { key: 'Active', val: 'Initializing', color: '#f50' },
        { key: 'Disconnected', val: 'Registered', color: '#f50' },
        { key: 'PreparingSession', val: 'AgentError', color: '#f50' },
        { key: 'Reconnecting', val: 'AgentError', color: '#f50' },
        { key: 'NonBrokerSession', val: 'AgentError', color: '#f50' },
        { key: 'Other', val: 'AgentError', color: '#f50' }
    ]
}
