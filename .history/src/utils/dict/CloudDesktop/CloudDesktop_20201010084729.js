export default {
    ...
    // 桌面类型
    C_D_DESKTOP_TYPE: [
        { key: 'Random', val: '随机桌面', color: '#2db7f5' },
        { key: 'StaticDiscard', val: '静态还原', color: '#2db7f5' },
        { key: 'StaticStore', val: '静态不还原', color: '#2db7f5' }
    ],
    // 桌面状态
    C_D_DESKTOP_STATE: [
        { key: 'DesktopCreating', val: '创建中', color: '#faad14' },
        { key: 'DesktopSuccess', val: '成功', color: '#2db7f5' },
    ...
    C_D_DESKTOP_LIST_REGISTRATIONSTATE: [
        { key: 'Unregistered', val: 'Unregistered', color: '#2db7f5' },
