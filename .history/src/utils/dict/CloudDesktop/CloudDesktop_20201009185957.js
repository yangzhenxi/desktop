export default {
    ...
    C_D_DESKTOP_LIST_STATE: [
        { key: 'Unmanaged', val: '关机', color: '#52c41a' },
        { key: 'Unknown', val: '开机', color: '#f50' },
        { key: 'Unavailable', val: '关机', color: '#52c41a' },
        { key: 'On', val: '开机', color: '#f50' },
        { key: 'Off', val: '关机', color: '#52c41a' },
        { key: 'Suspended', val: '开机', color: '#f50' },
        { key: 'TurningOn', val: '关机', color: '#52c41a' },
        { key: 'TurningOff', val: '开机', color: '#f50' },
        { key: 'Suspending', val: '关机', color: '#52c41a' },
        { key: 'resuming', val: '开机', color: '#f50' }
    ]
}
