            ...
            columns: [
                ...
                },
                {
                    ...
                    customRender: async (val, row, index) => {
                        ...
                        data = this.deepGet(await usermanageListuser({ name: 'ou=ABC,ou=Users,ou=Citrix,dc=cloud,dc=com' }), 'list', [])

                        console.log(mergeCellKey(row.display_name, data, 'display_name'))
