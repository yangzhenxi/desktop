  ...
  <page-header-wrapper :title="false">
    ...
    <m-table
      ...
      <template slot="progress" slot-scope="text,record">
        <a-progress v-if="record.state==='SYSTEM_TASK_STATE_SUCCESS'" :percent="text" style="color:#fff" />
        <a-progress v-if="record.state==='SYSTEM_TASK_STATE_FAIL'" status="exception" :percent="text" style="color:#fff" />
        <a-progress v-if="record.state==='SYSTEM_TASK_STATE_RUNNING'" status="active" :percent="text" style="color:#fff" />
        <a-progress v-if="record.state==='SYSTEM_TASK_STATE_UNSPECIFIED'" status="active" :percent="text" style="color:#fff" />
      </template>
    </m-table>
  </page-header-wrapper>
</template>
