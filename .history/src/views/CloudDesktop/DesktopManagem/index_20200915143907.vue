        ...
        <a-card>
          <a-row class="tree_head">
            ...
            <a-col :span="14">
              ...
              <a-button type="primary" shape="circle" style="margin-left:10px" @click="$refs.Edit.Edit()">
                <m-icon
                  type="xiugai"
                  class="icon" />
              </a-button>
              <a-button style="margin-left:10px" type="danger" shape="circle" @click="TreeDelete">
                <m-icon
                  type="shanchu"
                  class="icon" />
              </a-button>
...
import { DesktopTemplatList } from '@/api/CloudDesktop/DesktopManagem'
...
export default {
  ...
  methods: {
      async getTPgroup () {
          const res = await DesktopTemplatList()
