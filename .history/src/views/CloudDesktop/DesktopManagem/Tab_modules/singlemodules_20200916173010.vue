            ...
            <a-row :gutter="[16,16]">
              <a-col :span="8">
                <div class="box">
                  ...
                  <span class="text" @click="OnlineEdit">在线编辑</span>
                </div>
              </a-col>
              <a-col :span="8">
                <div class="box" @click="$refs.ManageRelease.Add($route.query.item)">
                  <m-icon
              ...
              <a-col :span="8" @click="$refs.ManageAttributes.Attribute($route.query.item)">
                <div class="box">
                  <m-icon
                    type="tongji"
        ...
        <a-tab-pane
          ...
          <m-table
            ...
            <template slot="action" slot-scope="text,record">
              <a-button type="primary" shape="circle" icon="form" @click="$refs.VersionEdit.Edit(record)" style="margin-right:20px" />
              <a-button type="danger" shape="circle" @click="VersionDelete(record)"> <a-icon type="delete" /></a-button>
            </template>
          </m-table>
        </a-tab-pane>
        <a-tab-pane
          ...
          <a-spin :spinning="loading">
            <a-form :form="form">
              ...
              <a-form-item :wrapperCol="{span: 10, offset: 12}">
                <a-button type="primary" style="margin-bottom:20px;" @click="Configure">提交</a-button>
              </a-form-item>
            </a-form>
          </a-spin>
        </a-tab-pane>
...
import { DesktopTemplateVersionList, DesktopTemplateVersionRevert, DesktopTemplatePatch, DesktopTemplateVersionMerge, DesktopTemplateVersionDelete, DesktopTemplateConfigure, DesktopTemplateDelete, DesktopTemplateNetworkList } from '@/api/CloudDesktop/DesktopManagem'
...
export default {
  ...
  methods: {
    ...
    callback (key) {
        console.log(key)
        DesktopTemplateNetworkList().then(rss => {
            console.log(res)
        })
    },
