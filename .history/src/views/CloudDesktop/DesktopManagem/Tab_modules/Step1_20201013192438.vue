            ...
            nameRepeatValidator(
                {
                    data: async () => {
                        try {
                            const validatorName = this.deepGet(await DesktopTemplateAllList(), 'data', [])
                            const taskName = this.deepGet(await DesktopTemplateGetAllTask(), 'data', [])
                            taskName.forEach(u => {
                                this.validatorName.push({ name: u.tpName })
                            })
