    ...
    <a-form
      ...
      <a-form-item
        ...
        <a-select
          placeholder="请选择资源池"
          @change="getdataCenter"
          v-decorator="['dataStores', { rules: [{required: true, message: '请选择资源池'}] }]">
          <a-select-option v-for="(i,index) in dataStores" :key="index" :value="i.name">{{ i.name }}</a-select-option>
        </a-select>
      </a-form-item>
      <a-form-item
        label="网络"
      ...
      <a-form-item
        ...
        <a-slider
          v-decorator="['memoryMB', { rules: [{required: true, message: '请输入插槽核心'}] }]"
          :min="1"
          :max="30" />
      </a-form-item>
      <a-form-item
        ...
        <a-slider
          v-decorator="['capacityKB', { rules: [{required: true, message: '请输入插槽核心'}] }]"
          :min="1"
          :max="80" />
      </a-form-item>
...
export default {
  ...
  methods: {
      ...
      clusterOrHost (value) {
          ...
          this.form.resetFields(['networks', 'dataStores'])
      },
    nextStep () {
      const that = this
      const {
