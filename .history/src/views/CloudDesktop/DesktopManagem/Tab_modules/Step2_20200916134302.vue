  ...
  <div class="step2">
    <a-form
      ...
      <a-form-item
        ...
        <a-select
          placeholder="请选择数据中心"
          v-decorator="['group', { rules: [{required: true, message: '请选择数据中心'}] }]">
          <a-select-option v-for="(i,index) in this.data.DataCenterList" :value="i.name">i.name</a-select-option>
        </a-select>
      </a-form-item>
      <a-form-item
        label="集群/主机"
...
export default {
  ...
  methods: {
      // 解析datacenterList的数据
      getdataCenter () {
        console.log(this.data.DataCenterList)
