...
import { DesktopTemplateVersionList, DesktopTemplateVersionRevert, DesktopTemplatePatch, DesktopTemplateVersionMerge } from '@/api/CloudDesktop/DesktopManagem'
