<template>
  <div v-if="visible">
    <a-spin :spinning="spinning">
      <a-card :title="moduleData.groupName">
              ...
              <a-row
                ...
                <a-col :span="16">
                  ...
                  <div class="modules_text">
                    <span>所属分组: </span>
                    <span> {{ moduleData.groupName }}</span>
                  </div>
                  <div class="modules_text">
                    <span>所在服务器: </span>
                  ...
                  <div class="modules_text">
                    <span>创建时间: </span>
                    <span>{{ moduleData.createTime| convert('unix','YYYY-MM-DD') }}</span>
                  </div>
                  <div class="modules_text">
                    <span>版本状态: </span>
                    <a-tag color="#108ee9">
                  ...
                  <div
                    ...
                    <span>运行状态: </span>
                    <!-- :number-style="{backgroundColor: toDict(moduleData.isRunning,'C_STATE').color}" -->
                    <a-badge
                      :count="moduleData.isRunning | convert('C_STATE')" />
                  </div>
                  <div class="modules_text">
                    <span>IP: </span>
...
export default {
  ...
  methods: {
        ...mapMutations(['SET_MODULEDATA', 'SET_TEMPLATEID']),
    // 显示详情页面
    ...
    reduction () {
        if (!this.disabled) {
            this.$confirm({
                title: '将模版主机还原至' + this.moduleData.version + '版本，在线编辑的内容将丢失，是否继续?',
                content: '点击确定即可还原',
                onOk: () => {
