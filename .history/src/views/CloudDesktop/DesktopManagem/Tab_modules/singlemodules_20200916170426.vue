            ...
            <a-form :form="form">
              ...
              <a-form-item
                ...
                <a-select
                  ...
                  v-decorator="['CPU', { rules: [{required: true, message: '请选择CPU核心数'}] }]">
              ...
              <a-form-item
                ...
                <a-select
                  placeholder="请选择插槽核心"
                  v-decorator="['solt', { rules: [{required: true, message: '请选择插槽核心'}] }]">
                  <a-select-option value="1">1</a-select-option>
                  <a-select-option value="2">2</a-select-option>
                </a-select>
              </a-form-item>
...
import { DesktopTemplateVersionList, DesktopTemplateVersionRevert, DesktopTemplatePatch, DesktopTemplateVersionMerge, DesktopTemplateVersionDelete } from '@/api/CloudDesktop/DesktopManagem'
