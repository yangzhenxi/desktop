...
import { DesktopTemplateNetworkList, DesktopTemplateConfigure } from '@/api/CloudDesktop/DesktopManagem'
export default {
  ...
  data () {
    return {
      loading: false,
      sliderDisabled: this.Disabled,
      loadingConfig: false,
      netword: [] // 网络,
    }
  },
  created () {
      console.log(console.log(this.Disabled))
  },
  methods: {
    async GetNetword () {
      const obj = {
