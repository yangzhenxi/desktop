  ...
  <a-spin :spinning="loading">
    <a-form
      ...
      <a-form-item
        ...
        <a-row>
          <a-col :span="12">
            <a-slider v-model="inputValue1" :min="2" :max="20" />
          </a-col>
          <a-col :span="4">
            <a-input-number v-model="inputValue1" :min="2" :max="32" style="marginLeft: 16px" />
          </a-col>
        </a-row>
      ...
      <a-form-item
        ...
        <a-row>
          ...
          <a-col :span="4">
            <a-input-number
v-model="inputValue1"
:min="2" :max="32" style="marginLeft: 16px" :formatter="value => `${value}GB`"
        ...
        Configure () {
            ...
            this.form.validateFields(async (errors, values) => {
                if (!errors) {
                    ...
                    values.capacityKB = this.inputValue1 * 1024 * 1024
                    values.memoryMB = this.inputValue2 * 1024
