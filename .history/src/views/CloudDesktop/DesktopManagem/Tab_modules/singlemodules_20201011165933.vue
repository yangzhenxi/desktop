              ...
              <a-row
                ...
                <a-col :span="16">
                  ...
                  <div
                    ...
                    <a-badge :count="moduleData.isRunning | convert('C_STATE')" />
                  </div>
                  <div class="modules_text">
                    <span>IP: </span>
...
export default {
    ...
    methods: {
        ...
        Release (res) {
            ...
            console.log(this.$refs.tabs.$refs.tab1.$refs)
            console.log(this.$refs.tabs.$refs.tab1.$refs.table.refresh())
