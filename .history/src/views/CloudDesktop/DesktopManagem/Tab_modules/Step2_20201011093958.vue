        ...
        if (this.oldData) {
            ...
            this.$nextTick(() => {
                this.form.setFieldsValue({
                    capacityKB: this.oldData.name,
                    clusterOrHost: this.oldData.group,
                    cpuNum: this.oldData.software,
                    memoryMB: this.oldData.software,
                    network: this.oldData.software,
                    resourcePools: this.oldData.software,
                    socket: this.oldData.software,
                    dataCenter: this.oldData.image
                })
            })
        }
    },
