  ...
  <div class="step2">
    <a-form
      ...
      <a-form-item
        ...
        <a-row>
          <a-col :span="18">
            <a-slider v-model="inputValue1" :min="2" :max="32" />
          </a-col>
          <a-col :span="4">
            <a-input-number
              v-model="inputValue1"
...
export default {
    ...
    mounted () {
        if (Object.keys(this.formValue).length > 5) {
            this.$nextTick(() => {
                this.inputValue1 = this.formValue.memoryMB / 1024
                this.inputValue2 = this.formValue.capacityKB / 1024 / 1024
            ...
            if (this.is_cluster) {
                ...
                this.clusters.forEach(u => {
                    if (u.name === value) {
                        ...
                        u.resource_pools.length === 1 ? this.disable_pool = true : this.resource_pools = u.resource_pools


                        if (this.resource_pools.length === 1) {
                ...
                this.hosts.forEach(u => {
                    if (u.name === value) {
                        ...
                        console.log(this.resource_pools)
                        this.data_stores = u.data_stores
                        this.SET_SPACE(u.data_stores)
                    }
                })
        ...
        nextStep () {
            ...
            validateFields((err, values) => {
                if (!err) {
                    ...
                    values.memoryMB = this.inputValue1 * 1024
                    values.capacityKB = this.inputValue2 * 1024 * 1024
