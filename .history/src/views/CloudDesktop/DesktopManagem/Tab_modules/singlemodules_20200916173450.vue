            ...
            <a-row :gutter="[16,16]">
              <a-col :span="8">
                <div class="box">
                  ...
                  <span
                    class="text"
                    @click="OnlineEdit">在线编辑</span>
                </div>
              </a-col>
              <a-col :span="8">
                <div
                  class="box"
                  @click="$refs.ManageRelease.Add($route.query.item)">
                  <m-icon
              ...
              <a-col
                :span="8"
                @click="$refs.ManageAttributes.Attribute($route.query.item)">
                <div class="box">
                  <m-icon
                    type="tongji"
            ...
            <a-form :form="form">
              ...
              <a-form-item
                ...
                <a-select
                  ...
                  <a-select-option v-for="(i,index) in netword" :key="index" :value="i.name">ant-design@alipay.com</a-select-option>
                </a-select>
              </a-form-item>
              <a-form-item
                label="内存"
