                    ...
                    <a-col
                      ...
                      <a-row
                        ...
                        <a-col
                          ...
                          <div class="text">
                            <span>创建时间: </span>
                            <span>{{ i.createTime | convert() }}</span>
                          </div>
                          <div class="text">
                            <span>版本状态: </span>
                            <span>{{ i.version }}</span>
                          ...
                          <div class="text" style="overflow: inherit;">
                            <span>运行状态: </span>
                            <a-badge :number-style="{backgroundColor: 'red'}" :count="i.isRunning | convert('C_STATE')" />
                            <!-- <span>{{ i.isRunning | convert('C_STATE') }}</span> -->
                            <!-- toDict(i.isRunning,'C_STATE').color -->
                          </div>
                          <div class="text">
                            <span>IP: </span>
                            <span>{{ i.ip }}</span>
  ...
  methods: {
    ...
    toRouter (key) {
      ...
      this.TPAllList.forEach((u) => {
        ...
        //   u.isRunning = convert(u.isRunning, 'C_STATE')
          i++
          if (i <= 8) {
