...
export default {
    ...
    methods: {
        Add (record) {
            ...
            this.columns.forEach(u => { if (columnsTitle.indexOf(u.title) !== -1) { this.checkedValues.push(u.title) } })
        },
        handleSubmit () {
            const result = this.columns.forEach(u => {return this.checkedValues.indexOf(u.title) !== -1 })
            let columns = {}
