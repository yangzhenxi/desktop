        ...
        async handleSubmit () {
            ...
            if (this.IsvalidatorSuccess) {
                ...
                for (let i = 0; i < this.dataArr.length; i = i + 30) {
                    if (Math.floor(this.data.length / 30) > 1 && i === 0) {
                        const fileData = this.dataArr.split((i * 30), (i + 1) * 30)
                    } else if (Math.floor(this.data.length / 30) > 1) {
                        const fileData = [...this.dataArr, ...this.dataArr.split((i * 30), (i + 1) * 30)]
                    } else {
                       const fileData = this.dataArr
                    }
                    const obj = {
