    ...
    methods: {
        ...
        async handleSubmit () {
            ...
            if (this.IsvalidatorSuccess) {
                ...
                console.log(this.dataArr.slice(30, 60))
                console.log(this.dataArr.slice(60, 90))
                console.log(this.dataArr.slice(90, 120))
                console.log(this.dataArr.slice(120, 150))
                console.log(this.dataArr.slice(150, 201))
