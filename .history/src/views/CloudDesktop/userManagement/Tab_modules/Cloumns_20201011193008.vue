  ...
  >
    <a-spin :spinning="loading">
      <a-form :form="form" layout="vertical">
        <a-checkbox-group @change="onChange" default-value="default">
          <a-row :gutter="[16,16]">
            <a-col :span="6" v-for="(i,index) in columns" :key="index">
              <a-checkbox :value="i.dataIndex" :disabled="i.disabled" style="color:white">
                {{ i.title }}
              </a-checkbox>
            </a-col>
          </a-row>
  ...
  methods: {
    Add (record) {
      this.visible = ''
        ...
        this.default = this.columns.map(u => u.disabled)
