                ...
                <a-row :gutter="24">
                  ...
                  <a-col :span="12">
                    <a-form-item label="用户不能更改密码">
                      <a-switch
                        :disabled="cannotChangePWDdisabled"
...
import { nameValidator, telValidator, EmailValidator, nameRepeatValidator } from '@/utils/validator'
...
export default {
  ...
  data () {
    return {
      ...
      pwdNotSetdisabled: false,
      cannotChangePWDdisabled: false,
      passSet: Object,
      currentGroup: {} // 修改之前的组
    }
  },
  methods: {
    ...
    onChange (checked) {
      ...
      if (checked) {
        this.passSet.pwdNotSet = false
        this.passSet.cannotChangePWD = false
      }
    },
    nameValidator,
    telValidator,
