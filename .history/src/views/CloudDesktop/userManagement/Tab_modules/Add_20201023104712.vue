                ...
                <a-form-item
                  ...
                  <a-input
                    ...
                    v-decorator="['display_name',
                                  { rules: [
                                      { required: true, message: '请输入名称！' },{min:2,max:8,message:'姓名长度为2-8个字符'},{validator:blankValidator},
                                    ],
                                    validateFirst: true
                                  },]" />
                </a-form-item>
...
import { nameValidator, telValidator, nameRepeatspecialValidator, EmailValidator, blankValidator } from '@/utils/validator'
