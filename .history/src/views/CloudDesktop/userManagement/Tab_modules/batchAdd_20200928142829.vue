            ...
            <a-row :gutter="[16,16]">
              <a-col :span="24">
                <a-select
                  ...
                  <a-select-option value="username" label="用户名">用户名</a-select-option>
                  <a-select-option value="group" label="组">组</a-select-option>
                  <a-select-option value="password" label="密码">密码</a-select-option>
