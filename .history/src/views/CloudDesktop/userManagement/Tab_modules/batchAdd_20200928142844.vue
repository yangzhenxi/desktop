            ...
            <a-row :gutter="[16,16]">
              <a-col :span="24">
                <a-select
                  ...
                  v-model="optionvalue">
                  <a-select-option value="name" disabled label="姓名">姓名</a-select-option>
                  <a-select-option value="username" disabled label="用户名">用户名</a-select-option>
                  <a-select-option value="group" disabled label="组">组</a-select-option>
                  <a-select-option value="password" disabled label="密码">密码</a-select-option>
                  <a-select-option value="email" label="邮箱">邮箱</a-select-option>
                  <a-select-option value="phone" label="手机号码">手机号码</a-select-option>
                </a-select>
              </a-col>
              <a-col :span="24">
                <a-button
...
export default {
  ...
  data () {
    return {
      ...
      dataArr: [],
      optionvalue: ['name', 'username', 'group', 'password'],
