            ...
            <a-row :gutter="[16,16]">
              <a-col :span="24">
                <a-select
                  ...
                  v-decorator="['option']">
                  <a-select-option value="china" label="姓名">姓名</a-select-option>
                  <a-select-option value="china" label="姓名">用户名</a-select-option>
                  <a-select-option value="china" label="姓名">组</a-select-option>
                  <a-select-option value="china" label="姓名">密码</a-select-option>
                  <a-select-option value="china" label="姓名">邮箱</a-select-option>
                  <a-select-option value="china" label="姓名">手机号码</a-select-option>
                </a-select>
              </a-col>
              <a-col :span="24">
                <a-button
