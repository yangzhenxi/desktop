            ...
            <a-row :gutter="[16,16]">
              <a-col :span="24">
                <a-select
                  ...
                  v-decorator="['option']">
                  <a-select-option value="name" label="name">姓名</a-select-option>
                  <a-select-option value="username" label="username">用户名</a-select-option>
                  <a-select-option value="group" label="group">组</a-select-option>
                  <a-select-option value="password" label="password">密码</a-select-option>
                  <a-select-option value="email" label="email">邮箱</a-select-option>
                  <a-select-option value="phone" label="phone">手机号码</a-select-option>
                </a-select>
              </a-col>
              <a-col :span="24">
                <a-button
