  ...
  >
    <a-spin :spinning="loading">
      <a-form :form="form" layout="vertical">
        <a-checkbox-group @change="onChange" :value="default" >
          <a-row :gutter="[16,16]">
            <a-col :span="6" v-for="(i,index) in columns" :key="index">
              <a-checkbox :value="i.title" :disabled="i.disabled" style="color:white">
                {{ i.title }}
              </a-checkbox>
              <template slot="label" slot-scope="option"></template>
            </a-col>
          </a-row>
        </a-checkbox-group>
