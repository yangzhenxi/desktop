        ...
        async handleSubmit () {
            ...
            if (this.IsvalidatorSuccess) {
                ...
                for (let i = 0; i < this.dataArr.length; i = i + 30) {
                    let fileData = []
                    if (Math.floor((this.data.length - u * 30) / 30) > 1 && i === 0) {
                        fileData = this.dataArr.split((i * 30), (i + 1) * 30)
                    } else if (Math.floor((this.data.length - u * 30) / 30) > 1) {
                        fileData = [...this.dataArr[0], ...this.dataArr.split((i * 30), (i + 1) * 30)]
                    } else {
