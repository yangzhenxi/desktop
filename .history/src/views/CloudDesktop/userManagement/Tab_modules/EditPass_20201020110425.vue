            ...
            this.form.validateFields(async (errors, values) => {
                ...
                if (!errors) {
                    ...
                    for (let i = 0; i < this.record.length; i++) {
                        values.first === undefined ? values.first = false : values.first = true
                        i === 0 ? names = this.record[i] : names = names + '.' + this.record[i]
                    }
                    ...
                    usermanageEditpassword(BatchResetPass).then(res => {
