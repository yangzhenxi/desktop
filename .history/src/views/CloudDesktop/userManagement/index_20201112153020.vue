        ...
        return {
            ...
            loadData: async parameter => {
                try {
                    ...
                    let data = []
                    this.record.dn === 'ou=Users,ou=Citrix,dc=cloud,dc=com' ? data = this.deepGet(await usermanageListuser({ name: this.record.dn }), 'list', []) : data = this.deepGet(await usermanageListuser({ name: this.record.dn }), 'list', [])
                    data.forEach(u => {
