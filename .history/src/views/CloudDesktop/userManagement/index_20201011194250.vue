    ...
    <a-row :gutter="16">
      ...
      <a-col
        ...
        <div class="head">
          <div class="btns">
            <a-button
              @click="$refs.TabAdd.add(treeeventObj)"
              type="primary">
              新增
            </a-button>
            <a-button
            ...
            <a-button
              @click="$refs.BatchTabAdd.BatchAdd(treeeventObj)"
              type="primary"
              style="margin-left:10px">
              批量新增
            </a-button>
          ...
          <div class="Serch">
            ...
            <div class="set" @click="$refs.columns.Add(columns)"><a-icon type="setting"></a-icon></div>
          </div>
        </div>
        <a-card>
          <m-table
          ...
          <cloumns ref="columns" @ok="customizeColumns"></cloumns>
        </a-card>
      </a-col>
    </a-row>
  </page-header-wrapper>
