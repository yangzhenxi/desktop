              ...
              <div class="global-search-wrapper" style="width: 300px">
                ...
                >
                  <!-- <template slot="dataSource">
                    <a-select-option v-for="item in dataSource" :key="item" :title="item">
                      <span className="global-search-item-count">{{ item }}</span>
                    </a-select-option>
                  </template> -->
                  <a-input>
                    <a-button
...
export default {
    ...
    methods: {
        ...
        handleSearch (value) {
            this.dataSource = []
            const res = []
            this.TAbleData.includes(value) ? this.dataSource = [value] : this.dataSource = ['2', '3', '4']
            this.TAbleData.forEach(u => {
                for (let o = 0; o < u.toString().length; o++) {
                    // console.log(u.substring(0, o + 1))
                    if (u.substring(o, (value.length) + o + 1) === value) {
                        res.push(u)
                    }
                }
            })
