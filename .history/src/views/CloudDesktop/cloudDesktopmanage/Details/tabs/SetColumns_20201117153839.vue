...
export default {
    ...
    methods: {
        Add (record) {
            ...
            this.columns.forEach(u => { if (columnsTitle.indexOf(u.HostedMachineName) !== -1) { return this.defaultColumns.push(u.HostedMachineName) } })
        },
        handleSubmit () {
            const result = this.columns.forEach(u => {
                return this.checkedValues.indexOf(u.HostedMachineName) !== -1
            })
            let columns = {}
