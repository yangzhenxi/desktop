      ...
      <a-col :span="18">
        <div>
          <div v-if="IsAllmodule">
              ...
              <a-card style="height:811px">
                <a-row :gutter="[36,24]">
                  ...
                  <div v-for="(i,index) in TPList" :key="index">
                    ...
                    <!-- 删除任务进度 -->
                    <a-col :span="8" v-if="i.state==='DESKTOP_STATE_DELETECREATING'">
            ...
            </a-card></a-row></div></a-col></a-row></a-spin>
    </a-col></div></a-row>
    </a-col>
    <!-- drawer -->
    <a-drawer
...
export default {
    ...
    data () {
        return {
            ...
            DesktopCreating: [], // 创建中
            DesktopDeleting: [{
                state: 'DESKTOP_STATE_DELETECREATING',
                progress: 80
            }], // 创建中
        ...
        async GetTPList (item, Creating) {
            ...
            try {
                ...
                res.forEach(u => {
                    ...
                    } else if (u.state === 'DesktopDeleting') {
