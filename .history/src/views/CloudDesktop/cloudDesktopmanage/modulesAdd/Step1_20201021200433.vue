      ...
      <a-form
        ...
        >
          <a-input
            autocomplete="off"
            placeholder="请输入桌面名称"
            v-decorator="['name', { rules: [{required: true, message: '请输入桌面名称'},{validator:nameValidator}],validateFirst: true }]" />
        </a-form-item>
        <a-form-item
          label="名称前缀"
        >
          <a-input
            autocomplete="off"
            placeholder="请输入名称前缀"
            v-decorator="['naming_scheme', { rules: [{required: true, message: '请输入名称前缀'},{min:1,max:13,message:'长度为1-13'},{validator:namingScheme}] }]" />
        </a-form-item>
...
<script>
import { nameValidator, namingScheme } from '@/utils/validator'
