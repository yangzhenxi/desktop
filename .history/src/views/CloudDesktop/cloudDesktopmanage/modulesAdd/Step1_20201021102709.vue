      ...
      <a-form
        ...
        >
          <a-input
            autocomplete="off"
            placeholder="请输入桌面名称"
            v-decorator="['name', { rules: [{required: true, message: '请输入桌面名称'},{validator:nameValidator}] }]" />
        </a-form-item>
        <a-form-item
          label="名称前缀"
        >
          <a-input
            autocomplete="off"
            placeholder="请输入名称前缀"
            v-decorator="['naming_scheme', { rules: [{required: true, message: '请输入名称前缀'}] }]" />
        </a-form-item>
        ...
        <a-form-item label="名称格式">
          <a-select
            ...
            <a-select-option :value="1">字母填充</a-select-option>
            <a-select-option :value="2">数字填充</a-select-option>
          </a-select>
        </a-form-item>
        <a-row>
        ...
        <a-form-item label="桌面类型">
          <a-radio-group v-decorator="['desktop_type', { rules: [{required: true, message: '请选择桌面类型'}] }]">
            <a-radio value="0">随机桌面</a-radio>
            <a-radio value="1">静态还原</a-radio>
