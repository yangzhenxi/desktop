...
export default {
    ...
    methods: {
        ...
        async getOu (item) {
            ...
            this.validatorName = []
            this.loadings = false
            const Computers = this.deepGet(this.deepGet(await CloudDesktopOUList(), 'ou')[0], 'children', [])
            let OuList = this.deepGet(this.deepGet(this.deepGet(await CloudDesktopOUList(), 'ou')[0], 'children', []), 'children', [])
