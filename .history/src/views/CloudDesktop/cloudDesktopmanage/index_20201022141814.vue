              ...
              <a-card style="height:811px">
                <a-row :gutter="[36,24]">
                  ...
                  <div v-for="(i,index) in TPList" :key="index">
                    ...
                    <a-col :span="8" v-else-if="i.state==='DESKTOP_STATE_CREATING'">
                      <a-row
                        class="modules"
                        :gutter="16">
                        <a-col :span="8">
                      ...
                      <a-row
                        ...
                        <a-col :span="16">
                          <a-result
                            ...
                            <template #extra>
                              <div>
                                <a-button key="console" type="primary" style="margin-right:10px">
                                  查看详情
                                </a-button>
                      ...
                      <a-timeline>
                        <a-timeline-item v-for="u in DesktopCreatingDrawer.steps" :key="u.id" :color="toDict(u.state,'C_D_DESKTOP_TASK_ATSTE').color">
                          ...
                          <p style="display:flex;justify-content: space-between">
                            ...
                            {{ i.progress }}
                            <a-progress :percent="parseInt(u.progress)" status="active" style="width:80%;" />
                          </p>
                        </a-timeline-item>
                      </a-timeline>
                    </a-drawer>
            ...
            for (let i = 0; i < this.DesktopFailId.length; i++) {
                await CloudDesktopTaskGet({ id: this.DesktopFailId[i] }).then(result => {
                    ...
                    this.DesktopFail.forEach(u => {
                        u.id === i.id ? u.steps = i.steps : console.log(1)
                    })
                })
            }
            const AllTPlist = [...this.DesktopCreating, ...this.DesktopSuccess, ...this.DesktopFail]
