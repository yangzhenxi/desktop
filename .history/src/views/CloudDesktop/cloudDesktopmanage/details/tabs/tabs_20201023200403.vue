          ...
          onOk: () => {
            return new Promise(async (resolve, reject) => {
                ...
                await CloudDesktopMachinePower(obj).then(res => {
                    ...
                    this.$refs.tab1.getState(deepGet(res, 'data', []), 'PowerState')
                    resolve()
                }).catch(() => {
            ...
            return new Promise(async (resolve, reject) => {
              ...
              const obj = {
                ...
                await CloudDesktopMachineSetMaintenanceMode(obj).then(res => {
                    this.$message.success('操作成功')
                    this.$refs.tab1.getState(deepGet(res, 'data', []), 'MaintenanceMode')
                    resolve()
                }).catch(() => {
                    this.$message.error('操作失败')
                    resolve()
          ...
          onOk: () => {
            return new Promise(async (resolve, reject) => {
              ...
              const obj = {
                ...
                await CloudDesktopMachineSetMaintenanceMode(obj).then(res => {
                    this.$message.success('操作成功')
                    const result = res.map(u => u.id)
                    this.$refs.tab1.getState(deepGet(result, 'MaintenanceMode')
                    resolve()
                }).catch(() => {
                    this.$message.error('操作失败')
                    resolve()
