    ...
    async GetTabData (tab) {
        ...
        switch (tab) {
            case 1:
                ...
                break
            case 2:
                result = deepGet(await CloudDesktopPolicyList({ desktop_id: this.datasource.id }), 'data', [])
                break
            case 3:
                result = deepGet(await CloudDesktopSessionList({ desktop_id: this.datasource.id }), 'data', [])
                break
            case 4:
                result = deepGet(await CloudDesktopGroupGet({ desktop_id: this.datasource.id }), 'data', [])
                break
        }
        console.log(result)
    }
