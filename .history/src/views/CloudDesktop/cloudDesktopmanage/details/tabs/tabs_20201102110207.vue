    ...
    async GetTabData (tab) {
        ...
        switch (tab) {
            case 1:
                ...
                break
            case '2':
                this.result = deepGet(await CloudDesktopPolicyList({ desktop_id: this.datasource.id }), 'data', [])
                break
            case '3':
                this.result.push(deepGet(await CloudDesktopSessionList({ desktop_id: this.datasource.id }), 'data', []))
                break
            case '4':
