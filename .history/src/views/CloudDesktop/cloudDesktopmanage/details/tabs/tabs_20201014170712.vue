<template>
  <a-card>
    ...
    <add-users ref="users" @ok="customizeColumns"></add-users>
    <add-group ref="group" @ok="customizeColumns"></add-group>
  </a-card>
</template>
  ...
  methods: {
    ...
    changeActive (val) {
      ...
      if (val === '1') {
        ...
        this.$refs.tab2.$refs.table.refresh()
      } else if (val === '3') {
        this.isSearchVisible = false
        this.isActiveVisible = true
