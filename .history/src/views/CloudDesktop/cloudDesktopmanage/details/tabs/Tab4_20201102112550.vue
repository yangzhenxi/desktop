            ...
            // CloudDesktopGroupGet(this.queryParam).then((res) => {
                ...
                this.$nextTick(() => {
                        this.form.setFieldsValue({
                            peak: '1',
                            buffer_size_percent: this.datasource.peak_buffer_size_percent,
                            disconnect_action: this.datasource.peak_disconnect_action,
                            disconnect_timeout: this.datasource.peak_disconnect_timeout,
                            log_off_action: this.datasource.peak_log_off_action,
                            log_off_timeout: this.datasource.peak_log_off_timeout
                        })
                    // }
                    this.spinning = false
                })
        ...
        if (value === '1') {
            // CloudDesktopGroupGet(this.queryParam).then((res) => {
                this.$nextTick(() => {
                        this.form.setFieldsValue({
                            peak: '1',
                            buffer_size_percent: this.datasource.peak_buffer_size_percent,
                            disconnect_action: this.datasource.data.peak_disconnect_action,
                            disconnect_timeout: this.datasource.peak_disconnect_timeout,
                            log_off_action: this.datasource.peak_log_off_action,
                            log_off_timeout: this.datasource.peak_log_off_timeout
                        })
            ...
            CloudDesktopGroupGet(this.queryParam).then((res) => {
                this.$nextTick(() => {
                        this.form.setFieldsValue({
                            peak: '0',
                            buffer_size_percent: this.datasource.off_peak_buffer_size_percent,
                            disconnect_action: this.datasource.off_peak_disconnect_action,
                            disconnect_timeout: this.datasource.off_peak_disconnect_timeout,
                            log_off_action: this.datasource.off_peak_log_off_action,
                            log_off_timeout: this.datasource.off_peak_log_off_timeout
                        })
                    this.spinning = false
                })
            })
