                ...
                this.$nextTick(() => {
                    if (res.data.OffPeakBufferSizePercent > 0) {
                        this.form.setFieldsValue({
                            ...
                            disconnect_action: res.data.OffPeakDisconnectAction,
                            disconnect_timeout: res.data.OffPeakDisconnectTimeout,
                            log_off_action: res.data.OffPeakLogOffAction,
                            log_off_timeout: res.data.OffPeakLogOffTimeout
                        })
                    } else {
                        this.form.setFieldsValue({
                            peak: 'false',
                            buffer_size_percent: res.data.PeakBufferSizePercent,
                            disconnect_action: res.data.PeakDisconnectAction,
                            disconnect_timeout: res.data.PeakDisconnectTimeout,
                            log_off_action: res.data.PeakLogOffAction,
                            log_off_timeout: res.data.PeakLogOffTimeout
                        })
                    }
                    this.spinning = false
                })
