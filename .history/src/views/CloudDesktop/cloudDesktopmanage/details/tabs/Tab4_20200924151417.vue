  ...
  <div>
    <a-form
      ...
      <a-form-item label="电源管理">
        <a-input
          placeholder="请选择电源管理"
          v-decorator="['name', { rules: [{required: true, message: '请选择电源管理'}] }]" />
      </a-form-item>
      <a-form-item label="断电连接">
        <a-input-number
          placeholder=""
          v-decorator="['name', { rules: [{required: true, message: '请输入名称前缀'}] }]" />
        <span style="color:white;margin:10px">分钟</span>
      ...
      <a-form-item :wrapperCol="{span: 16, offset: 9}">
        <a-button
          type="dashed"
          style="margin-right:10px;"
          @click="reset">清空</a-button>
        <a-button
          type="primary"
          :loading="loading"
