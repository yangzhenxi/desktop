...
import { CloudDesktopPolicyList, CloudDesktopSessionList } from '@/api/CloudDesktop/CloudDesktop'
const GroupColumns = [
    {
        title: '组',
        dataIndex: 'name'
    ...
    data () {
        return {
            ...
            User: async parameter => {
                ...
                // console.log(data)
                // const data2 = deepGet(deepGet(await CloudDesktopSessionList({ desktop_id: this.datasource.id }), 'data', []), 'users', [])
                return {
                    data
                }
            },
