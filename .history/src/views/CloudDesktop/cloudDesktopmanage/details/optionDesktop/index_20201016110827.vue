<template>
  <a-modal
    ...
    <a-spin :spinning="loading">
      <div class="btn" style="margin:0 0 20px 20px">
        <a-button type="primary" size="small">批量开机</a-button>
        <a-button type="danger" style="margin-left:15px" size="small">批量关机</a-button>
        <a-button type="primary" style="margin-left:15px" size="small">批量重启</a-button>
        <a-button type="primary" style="margin-left:15px" size="small">批量开启维护模式</a-button>
        <a-button type="primary" style="margin-left:15px" size="small">批量关闭维护模式</a-button>
      </div>
      <m-table
        :columns="columns"
        :data="loadData"
