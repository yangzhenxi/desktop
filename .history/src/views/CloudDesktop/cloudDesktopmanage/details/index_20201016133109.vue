...
import { CloudDesktopMachinePower, CloudDesktopMachineSetMaintenanceMode } from '@/api/CloudDesktop/CloudDesktop'
export default {
  components: {
    Tabs,
    MIcon,
      ...
      this.$confirm({
        ...
        onOk: () => {
          return new Promise(async (resolve, reject) => {
              const power = []
              this.$refs.tabs.checked.forEach(u => {
                  if (u.PowerState === 'Off') {
    ...
    OffCloudDesktop () {
      this.$confirm({
        ...
        onOk: () => {
          return new Promise(async (resolve, reject) => {
           const power = []
           console.log(this.$refs.tabs.$refs.tab1.loadData)
                this.$refs.tabs.checked.forEach(u => {
                    if (u.PowerState === 'On') {
                        power.push(u.HostedMachineName)
                    }
