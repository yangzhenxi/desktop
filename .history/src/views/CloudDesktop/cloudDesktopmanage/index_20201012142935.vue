...
import { CloudDesktopTPList, CloudDesktopOUList, CloudDesktopDeleteOU } from '@/api/CloudDesktop/CloudDesktop'
  ...
  methods: {
    ...
    TreeDelete () {
      this.$confirm({
        ...
        content: '点击确定即可删除',
        onOk: () => {
            CloudDesktopDeleteOU({ name: this.record.title }).thne(res => {
