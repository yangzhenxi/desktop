    ...
    methods: {
        ...
        handleClick (value, title) {
            ...
            if (title === 'CPU') {
                ...
                this.dataSource[1].ChartsData[1].count = (memoryUsage / 1024).toFixed(2)
                this.dataSource[1].ChartsData[0].count = ((Arr[0].memory_capacity / 1024 / 1024 / 1024) - (memoryUsage / 1024)).toFixed(2)
                this.dataSource[1].ChartsData[0].percent = 1 - ((memoryUsage / 1024).toFixed(2) / ((Arr[0].memory_capacity / 1024 / 1024 / 1024)))
                this.dataSource[1].ChartsData[1].percent = (memoryUsage / 1024).toFixed(2) / ((Arr[0].memory_capacity / 1024 / 1024 / 1024))
            }
            console.log(Arr)
        },
        deepGet
