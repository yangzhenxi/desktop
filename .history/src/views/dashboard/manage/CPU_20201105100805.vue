    ...
    methods: {
        ...
        handleClick (value, title) {
            ...
            if (title === 'CPU') {
                ...
                const Surplus = {
                    item: '剩余内存',
                    count: ((Arr[0].memory_capacity / 1024 / 1024 / 1024) - (Arr[0].memory_usage / 1024)).toFixed(2),
                    percent: 1 - ((Arr[0].memory_usage / 1024).toFixed(2) / ((Arr[0].memory_capacity / 1024 / 1024 / 1024)))
                }
                const Used = {
                        item: '已用内存',
                        count: 2,
                ...
                this.dataSource[1].ChartsData[0].count =
                this.dataSource[1].ChartsData[0].percent =
