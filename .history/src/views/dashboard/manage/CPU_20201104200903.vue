...
export default {
    ...
    methods: {
        async loadData () {
            ...
            this.dataSource[0].ChartsData[0].percent = (cpuUsage / 1000) / (cpuCapacity - (cpuUsage / 1000))
            this.dataSource[0].ChartsData[1].percent = 1 - (cpuUsage / 1000) / (cpuCapacity - (cpuUsage / 1000))
