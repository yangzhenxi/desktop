    ...
    methods: {
        ...
        handleClick (value, title) {
            ...
            if (title === 'CPU') {
                ...
                this.dataSource[0].ChartsData[0].count = (Arr[0].cpuCapacity - (Arr[0].cpu_usage / 1000)).toFixed(2)
                console.log(Arr[0].cpuCapacity)
                console.log(-(Arr[0].cpu_usage / 1000))
                this.dataSource[0].ChartsData[0].percent = 1 - (Arr[0].cpu_usage / 1000) / (Arr[0].cpuCapacity - (Arr[0].cpu_usage / 1000))
                this.dataSource[0].ChartsData[1].percent = (Arr[0].cpu_usage / 1000) / (Arr[0].cpuCapacity - (Arr[0].cpu_usage / 1000))
            } else {
