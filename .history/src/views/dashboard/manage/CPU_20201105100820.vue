        ...
        handleClick (value, title) {
            ...
            if (title === 'CPU') {
                ...
                const Used = {
                        ...
                        percent:(Arr[0].memory_usage / 1024).toFixed(2) / ((Arr[0].memory_capacity / 1024 / 1024 / 1024))
                }
                this.dataSource[1].ChartsData[1] = [Surplus, Used]

                this.dataSource[1].ChartsData[1].count = 
                this.dataSource[1].ChartsData[0].count =
                this.dataSource[1].ChartsData[0].percent =
                this.dataSource[1].ChartsData[1].percent = 
            }
        },
        deepGet
    }
